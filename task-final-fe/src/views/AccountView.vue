<template>
  <v-container class="d-flex align-center justify-center" style="min-height: 100vh;">
    <v-card width="100%" class="pa-5">
      <v-card-title class="justify-center">List Akun Dompetku</v-card-title>
      ...
      <template v-slot:top>
          ...
          <v-row style="padding-top: 10px" class="mb-4">
            <v-col cols="4" class="font-weight-bold" >Nama</v-col>
            <v-col cols="4" class="font-weight-bold">Balance</v-col>
            <v-col cols="4" class="font-weight-bold">Aksi</v-col>
          </v-row>
        </template>
