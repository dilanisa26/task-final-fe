  ...
  <v-app>
    <v-container>
      <v-card class="pa-5" outlined>
        <v-card-title class="text-h4">Dompetku</v-card-title>
        <v-divider></v-divider>
        ...
        <v-form @submit.prevent="addEntry">
          ...
          <v-select
            ...
            required
          ></v-select>
          <v-btn type="submit" color="green" class="mt-3">Submit</v-btn>
        </v-form>
...
export default {
  data() {
    return {
      ...
      categories: ["Makan", "Transport", "Uang Masuk", "Uang Keluar", "Other"],
