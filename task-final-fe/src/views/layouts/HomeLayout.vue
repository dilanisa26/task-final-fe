  ...
  <v-responsive>
    <v-app id="app">
      <v-navigation-drawer v-model="drawer">
        ...
        <div class="font-weight-bold">Welcome to Dompetku</div>
          <div class="font-weight-bold">Hello, {{ userStore.user?.name }}</div>
          <div class="font-weight-bold">Balance: Rp.{{ userStore.user?.balance }}</div>
        </v-sheet>
...
const sidebarLinks = [
  ...
  { icon: mdiAccount, text: 'List Akun', route: '/account-list' },
  { icon: mdiFormSelect, text: 'Form Akun', route: '/account-form' },
  { icon: mdiWallet, text: 'Dompetku', route: '/dompetku' },
  { icon: mdiKeyChange, text: 'Ubah Password', route:'/change-password'},
